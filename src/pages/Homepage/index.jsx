            ...
            <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
              <div className="flex flex-col md:gap-10 gap-[70px] items-start justify-start md:mt-0 mt-[194px] w-auto">
                <Button
                  ...
                  className="bg-transparent cursor-pointer font-bold leading-[normal] min-w-[84px] text-center text-white-A700 text-xl"
                >
                  About us
                </Button>
                <Button
                ...
                <Button
                  ...
                  className="bg-transparent cursor-pointer font-bold leading-[normal] min-w-[86px] text-center text-white-A700 text-xl"
                >
                  Solutions
                </Button>
              </div>
